            ...
            <div className={`space-y-6 transition-all duration-1000 delay-300 ${
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="card-hover bg-card/50 p-4 rounded-lg text-center">
                  <div className="text-2xl font-orbitron font-bold text-neon-blue">2024</div>
            ...
            <div className={`space-y-6 transition-all duration-1000 delay-500 ${
              ...
              <div className="space-y-4 text-lg text-muted-foreground leading-relaxed">
                <p>
                  ...
                  <span className="text-neon-purple font-semibold">Five Data and Products Pvt. Ltd</span>.
                </p>
              ...
              <div className="space-y-4 pt-6">
                ...
                <div className="space-y-3">
                  {[
                    'Computer Science Graduation Completed',
